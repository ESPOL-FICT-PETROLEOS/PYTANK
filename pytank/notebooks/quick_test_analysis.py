...
tank_with_aquifer = Tank(name=tank_name,
                         wells=well,
                         oil_model=oil_model,
...
analysis2 = Analysis(tank_class=tank_with_aquifer, freq="12MS", position="end")
...
water_visc = 0.6
analysis2.setup_carter_tracy_aquifer(aq_por=phi,
                                     ct=ct,
                                     res_radius=res_radius,
                                     aq_thickness=aq_thickness,
                                     theta=theta,
