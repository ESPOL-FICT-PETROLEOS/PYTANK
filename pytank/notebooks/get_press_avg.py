...
from pytank.constants.constants import (OIL_FVF_COL, GAS_FVF_COL, RS_COL, PRESSURE_COL, OIL_CUM_COL, GAS_CUM_COL, WATER_CUM_COL, LIQ_CUM,
                                        DATE_COL, WELL_COL, TANK_COL
                                        )
import pandas as pd
from pytank.fluid_model.fluid import OilModel
