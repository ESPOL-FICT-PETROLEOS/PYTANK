...
def normalize_date_freq(
    ...
    """
    Returns a pytank dataframe with a pytank DateTimeIndex which has a predefined frequency.
    ...
    Returns
    -------
    Series/DataFrame with changed index based on the pytank frequency. The pytank dataframe
    ...
    if cols_fill_na is not None:
        ...
        # These columns will default to nan where pytank dates appear, and will be replaced
