    ...
    def setUp(self):
        ...
        well1 = Well(
            ...
            prod_data=ProdVector(
                ...
                }, index=pd.date_range('2022-01-01', periods=5, freq='MS', name=DATE_COL))
            ),
            press_data=PressVector(
                freq=None,
                data=pd.DataFrame({
                    'PRESSURE_DATUM': [884.696858, 884.696858]
                }, index=pd.date_range('2022-01-01', periods=2, freq='D', name=DATE_COL))
            )
        )
        ...
        well2 = Well(
            ...
            press_data=PressVector(
                ...
                }, index=pd.date_range('2010-12-05', periods=2, freq='D', name=DATE_COL))
            )
        )

        df_pvt = pd.DataFrame({
            'Pressure': [14.7, 214.7, 414.7, 644.7, 714.7, 814.7, 914.7, 1014.7, 1514.7],
            'Bo': [1.037016316, 1.119258006, 1.130922092, 1.1414, 1.139779212, 1.138957404, 1.138363876, 1.137599138,
                   1.133330302],
